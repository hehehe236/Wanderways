export const IconGoogle = ({ addStyle }: { addStyle?: string }) => {
    return (
        <svg
            width='24'
            height='24'
            ...
            className={addStyle}
        >
            <g clipPath='url(#clip0_2274_2178)'>
                <path
                    fillRule='evenodd'
                    clipRule='evenodd'
            ...
            <defs>
                <clipPath id='clip0_2274_2178'>
                    <rect width='24' height='24' fill='white' className={addStyle} />
                </clipPath>
            </defs>
        </svg>
    );
